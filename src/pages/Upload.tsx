...
type BackgroundOption = "marble"| "wood"| "industrial"| "linen"| "brick"| "counter" | null;
...
export default function Upload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch('https://72jdmlb6-3500.brs.devtunnels.ms/upload-image', {
        method: 'POST',
        body: formData,
        headers: {
      ...
      try {
        ...
        const response = await fetch(`https://72jdmlb6-3500.brs.devtunnels.ms/remove-background`, {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token') || localStorage.getItem('devToken')}`,
                  ...
                  <div className="p-4 space-y-4 ">
                    {!selectedOption ? (
                      <div className="space-y-3 ">
                          ...
                          {showBackgroundOptions && (
                            <div className="absolute w-full mt-1 bg-gray-700 rounded-md shadow-lg z-10 ">
                              <div className="py-1">
                                ...
                                <button
                                  onClick={() => handleOptionSelect('industrial')}
                                  className="w-full text-left px-4 py-2 text-white hover:bg-gray-600"
                                >
                                  Industrial
                                </button>
                        ...
                        <div className="relative">
                          <button
                            onClick={() => handleGenerationTypeSelect('animation')}
